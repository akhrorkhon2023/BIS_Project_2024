...
{
      $id=intval($_GET['del']);
      $adn="delete from qollab_client where client_id=?";
 ...
 <!-- end HEAD--> 
  <body>
    ...
    <!--navbar-->
      ...
      <div class="page-head">
          <h2 class="page-head-title">Manage Clients</h2>
                ...
                <div class="card-body">
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <?php
                        ...
                        */
                        $ret="SELECT * FROM qollab_client"; //sql code to get all details of places.
                    ...
                    ?>
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center"><a class ="badge badge-success" href ="emp-update-client.php?client_id=<?php echo $row->client_id;?>">Update</a> 
                            <a class ="badge badge-danger" href ="emp-manage-clients.php?del=<?php echo $row->client_id;?>">Delete</a>
                            <a class ="badge badge-primary" href ="emp-view-client.php?client_id=<?php echo $row->client_id;?>">View</a>
                        </td>                      
                      </tr>
                        <?php }?>
                    </tbody>
