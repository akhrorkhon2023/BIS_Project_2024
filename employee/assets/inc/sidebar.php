              ...
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-table"></i><span>Places</span></a>
                    ...
                    <ul class="sub-menu">
                       <li><a href="emp-add-place.php">Add Place</a>
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-briefcase-edit-outline"></i><span>Clinets</span></a>
                    <ul class="sub-menu">
                      <li><a href="emp-add-client.php">Add Clinet</a>
                      </li>
                      <li><a href="emp-manage-clients.php">Manage Clinets</a>
                      </li>
