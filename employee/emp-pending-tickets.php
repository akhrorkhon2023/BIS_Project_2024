              ...
              <div class="card card-table">
                ...
                <div class="card-body">
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <?php
                        /*
                        *Lets get details of available places tickets! !
                        */
                        $ret="SELECT * FROM `qollab_place_tickets` where confirmation !='Approved' "; //sql code to get all details of places.
