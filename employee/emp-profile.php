    ...
    <!--Navigation Bar-->
      ...
      <!--End Sidebar-->
        ...
        <?php
            ...
            $ret="select * from qollab_employee where emp_id=?"; //sELECT ALL FROM PASSENGERS WHERE PASSENGER ID IS THE LOGGED ONE
                  ...
                  <div class="card-body">
                    <table class="no-border no-strip skills">
                      <tbody class="no-border-x no-border-y">
                        ...
                        <tr>
                          <td class="icon"><span class="mdi mdi mdi-table"></span></td>
                          <td class="item">Department <span class="icon s7-phone"></span></td>
