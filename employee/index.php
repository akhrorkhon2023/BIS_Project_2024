...
<?php
    ...
    if(isset($_POST['emp_login']))
    {
      ...
      $stmt=$mysqli->prepare("SELECT emp_email ,emp_pwd , emp_id FROM qollab_employee WHERE emp_email=? and emp_pwd=? ");//sql to log in user
...
<head>
    ...
    <title>Qo'llab - Employee Login</title>
