            ...
            <div class="col-sm-12">
               ...
               */         
                ...
                while($row=$res->fetch_object())
                 {
                    ?>
                <div class="card-header"><?php echo $row->client_fname;?> <?php echo $row->client_lname;?>  This Is Your Booked Place Proceed to checkout your ticket!   
                <?php }?>             
                </div>
                  ...
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <tbody>
                      ...
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center"><a href="user-checkout-ticket.php?client_id = <?php echo $row->client_id;?>"><button class="btn btn-success btn-sm">Checkout</button></a></td>
                      </tr>
                        <?php }?>
                    </tbody>
                  </table>
