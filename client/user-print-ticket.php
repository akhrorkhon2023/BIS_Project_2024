  ...
  <body>
    ...
    <!--Nav Bar-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">place Ticket</h2>
            ...
            <!--place Details-->
              <div id='printReceipt' class="invoice">
                <div class="row invoice-header">
                  ...
                  <div class="col-sm-5 invoice-order"><span class="invoice-id">Place Ticket For</span><span class="incoice-date"><?php echo $row->client_fname;?> <?php echo $row->client_lname;?></span></div>
                </div>
                <div class="row invoice-data">
                  <div class="col-sm-5 invoice-person"><span class="name"><?php echo $row->client_fname;?> <?php echo $row->client_lname;?></span><span><?php echo $row->client_email;?></span><span><?php echo $row->client_addr;?></span></div>
