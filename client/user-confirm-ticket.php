      ...
      <div class="page-head">
          ...
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
              ...
              <li class="breadcrumb-item"><a href="">Place Tickets</a></li>
            ...
            <div class="col-sm-12">
               ...
               */         
                ...
                while($row=$res->fetch_object())
                 {
                    ?>
                <div class="card-header"><?php echo $row->client_fname;?> <?php echo $row->client_lname;?>  This Is Your Booked place Ticket Proceed to Confirm checkout your ticket!   
                <?php }?>             
                </div>
                ...
                <div class="card-body">
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <tbody>
                         ...
                         */
                            //$aid=$_SESSION['client_id'];
                            $ret="SELECT * from qollab_client WHERE client_id=? && client_payment_code !=''";//sql to get details of our user
                            $stmt= $mysqli->prepare($ret) ;
                            $stmt->bind_param('i',$aid);
                            $stmt->execute() ;//ok
                            $res=$stmt->get_result();
                      ...
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center"><?php echo $row->client_payment_code;?></td>
                        <td class="center"><a href="user-confirm-checkout-ticket.php?client_id = <?php echo $row->client_id;?>"><button class="btn btn-sm btn-success">Confirm Payment</button></a></td>
                      </tr>
                        <?php }?>
                    </tbody>
                  </table>
