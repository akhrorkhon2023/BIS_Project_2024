 ...
 <!-- end HEAD--> 
  <body>
    ...
    <!--navbar-->
      ...
      <div class="page-head">
          <h2 class="page-head-title">Book Palce</h2>
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
              <li class="breadcrumb-item"><a href="pass">Dashboard</a></li>
              <li class="breadcrumb-item"><a href="#">Book Palce</a></li>
              <li class="breadcrumb-item active">Reserve Palce</li>
            </ol>
          </nav>
        </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Please Book Your Palce Accordingly                  
                </div>
                <div class="card-body">
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    ?>
                      ...
                      <td><?php echo $row->table_number;?></td>
                        ...
                        <td class="center">
                        <a href="user-book-specific-place.php?id=<?php echo $row->id?>"><button class="btn btn-success btn-sm">Book</button></a>
                        </td>
                      </tr>
                        <?php }?>
                    </tbody>
