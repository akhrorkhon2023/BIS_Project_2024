          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Canel Your Place Booking                 
                </div>
                <div class="card-body">
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <tbody>
                      ...
                      <td><?php echo $row->client_table_number;?></td>
                        ...
                        <td class="center">
                            <a href="user-cancel-specific-place.php?client_id=<?php echo $row->client_id?>"><button class="btn btn-danger btn-sm">Cancel</button></a>  
                        </td>
                      </tr>
                        <?php }?>
                    </tbody>
