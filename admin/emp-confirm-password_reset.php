<?php
    ...
    if(isset($_POST['approve']))
    {
            ...
            $query="update qollab_passwordresets set status = ? where pwd_id=?";
  ...
  <body>
    ...
    <!--Navigation Bar-->
      ...
      <div class="be-content">
       ...
       <?php
            $aid=$_GET['pwd_id'];
            $ret="select * from qollab_passwordresets where pwd_id=?";
                  ...
                  <form method ="POST">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="Client" value="<?php echo $row->email;?>"  id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
