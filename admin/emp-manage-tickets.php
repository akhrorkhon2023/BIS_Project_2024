...
if(isset($_GET['del']))
{
      ...
      $adn="delete from qollab_place_tickets where ticket_id=?";
              ...
              <div class="card card-table">
                ...
                <div class="card-body">
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <?php
                        /*
                        *Lets get details of available Tables tickets! !
                        */
                        $ret="SELECT * FROM `qollab_place_tickets` "; //sql code to get all details of Tables.
                    ...
                    ?>
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center"><?php echo $row->table_name;?></td>
                        <td class="center"><?php echo $row->booked_from;?></td>
                        <td class="center"><?php echo $row->booked_to;?></td>
                        <td class="center"><?php echo $row->price;?></td>
                        <td class="center"><?php echo $row->payment_code;?></td>
