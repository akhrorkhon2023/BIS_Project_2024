        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-6 col-xl-3">
              ...
              <div class="chart sparkline"><i class="material-icons ">book_outline</i></div>
                ...
                <?php
                    ...
                    $result ="SELECT count(*) FROM `qollab_place_tickets` ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->execute();
            ...
            <div class="col-12 col-lg-6 col-xl-3">
              ...
              <div class="chart sparkline"><i class="material-icons">supervisor_account</i></div>
                ...
                <?php
                  //code for summing up number of Clients 
                  $result ="SELECT count(*) FROM qollab_employee";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
                  $stmt->bind_result($pass);
                  $stmt->fetch();
            ...
            <div class="col-12 col-lg-6 col-xl-4">
              ...
              <div class="chart sparkline"><i class="material-icons">person</i></div>
                ...
                <?php
                  //code for summing up number of Clients 
                  $result ="SELECT count(*) FROM qollab_admin ";  
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
                  $stmt->bind_result($pass);
                  $stmt->fetch();
            ...
            <!-- <div class="col-12 col-lg-6 col-xl-3">
              ...
              <div class="chart sparkline"><i class="material-icons">local_activity</i></div>
                ...
                <?php
                  //code for summing up number of clients 
                  $result ="SELECT count(*) FROM qollab_passwordresets where status = 'Pending' ";  
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
                  $stmt->bind_result($pass);
                  $stmt->fetch();
              ...
              <div class="card card-table">
                ...
                <!--Start Table-->
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <tbody>
                      <?php
                        $ret="SELECT * FROM qollab_place_tickets WHERE confirmation ='Approved' LIMIT 10";
                        $stmt= $mysqli->prepare($ret) ;
                        $stmt->execute() ;//ok
                        $res=$stmt->get_result();
                        $cnt=1;
              ...
              <div class="card card-table">
                ...
                <!--Start Table-->
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <tbody>
                      <?php
                        $ret="SELECT * FROM qollab_employee ORDER BY RAND() LIMIT 10  "; //sql code to get all details of all employees
                        $stmt= $mysqli->prepare($ret) ;
                        $stmt->execute() ;//ok
                        $res=$stmt->get_result();
                        $cnt=1;
