 ...
 <?php
	...
	include('assets/inc/config.php');
      ...
      //sql to insert captured values
			$query="update qollab_employee set emp_fname=?, emp_lname=?, emp_phone=?, emp_passport=?, emp_nat_idno=?, emp_uname=?, emp_email=?, emp_dept=?, emp_pwd=? where emp_id=? ";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssssssssi',$emp_fname, $emp_lname, $emp_phone, $emp_addr, $emp_passport, $emp_uname, $emp_email, $emp_dept, $emp_pwd, $emp_id);
			$stmt->execute();
			/*
  ...
  <body>
    ...
    <!--Navigation Bar-->
      ...
      <div class="be-content">
        ...
        <?php
            $aid=$_GET['emp_id'];
            $ret="select * from qollab_employee where emp_id=?";
              ...
              <div class="card card-border-color card-border-color-success">
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Passport Number</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="emp_passport"  value="<?php echo $row->emp_passport;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
