 ...
 <?php
	...
	include('assets/inc/config.php');
      ...
      //sql to insert captured values
			$query="insert into qollab_employee (emp_fname, emp_lname, emp_phone, emp_addr, emp_passport, emp_uname, emp_email, emp_dept, emp_pwd) values(?,?,?,?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssssssss',$emp_fname, $emp_lname, $emp_phone, $emp_addr, $emp_passport, $emp_uname, $emp_email, $emp_dept, $emp_pwd);
			$stmt->execute();
			/*
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="emp_passport"  id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-success" value ="Add New Employee " name = "create_employee" type="submit">
