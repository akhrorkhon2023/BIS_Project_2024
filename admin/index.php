...
<?php
    ...
    if(isset($_POST['emp_login']))
    {
      ...
      $stmt=$mysqli->prepare("SELECT admin_email ,admin_pwd , admin_id FROM qollab_admin WHERE admin_email=? and admin_pwd=? ");//sql to log in user
...
<head>
    ...
    <title>Qo'llab - Admin Login</title>
